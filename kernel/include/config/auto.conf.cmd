deps_config := \
	...
	drivers/gpu/arm/bifrost/arbitration/ptm/Kconfig \
...
ifneq "$(KERNELVERSION)" "5.10.66"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "./scripts/gcc-wrapper.py aarch64-none-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "aarch64-none-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
...
ifneq "$(CC_VERSION_TEXT)" "aarch64-none-linux-gnu-gcc (GNU Toolchain for the Arm Architecture 11.2-2022.02 (arm-11.14)) 11.2.1 20220111"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "aarch64-none-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "aarch64-none-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(AR)" "aarch64-none-linux-gnu-ar"
include/config/auto.conf: FORCE
endif
