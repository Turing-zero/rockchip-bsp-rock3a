...
#define TSK_ACTIVE_MM 1136 /* offsetof(struct task_struct, active_mm) */
...
#define TSK_STACK_CANARY 1312 /* offsetof(struct task_struct, stack_canary) */
...
#define MM_CONTEXT_ID 832 /* offsetof(struct mm_struct, context.id.counter) */
